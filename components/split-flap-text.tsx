...
function SplitFlapChar({ char, index, animationKey, skipEntrance, speed, playClick }: SplitFlapCharProps) {
  ...
  const showOrangeDot = isU && isSettled && currentChar === "U"
  ...
  return (
    ...
    >
      ...
      {/* Orange dot inside U character */}
      {showOrangeDot && (
        <motion.div
          initial={{ scale: 0, opacity: 0 }}
          animate={{ scale: 1, opacity: 1 }}
          transition={{ delay: 0.3, duration: 0.4, ease: "easeOut" }}
          className="absolute z-20 rounded-full bg-accent"
          style={{
            width: "0.12em",
            height: "0.12em",
            bottom: "0.28em",
            ...
            boxShadow: "0 0 0.1em rgba(249, 115, 22, 0.6)",
          }}
        />
      )}
